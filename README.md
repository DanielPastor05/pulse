...
| | |
| --- | --- |
| **Automated checks** | 588 — 147 unit, 44 component, 46 integration against a real Postgres, 10 browser smoke tests, 341 end-to-end against the deployed instance |
...
```bash
npm test                  # 147 unit tests — pure logic, no I/O
