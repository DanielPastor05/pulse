...
export const messages = {
  ...
  nav: {
    ...
    assistantFailed: 'Could not open the assistant',
  ...
  composer: {
    ...
    emoji: 'Add an emoji',
    schedule: 'Schedule',
    scheduleHint: 'It goes out on the first traffic after that time. With nobody using the app, it waits.',
    scheduleWhen: 'Send after',
    scheduled: 'Message scheduled',
    scheduleFailed: 'Could not schedule that',
    scheduleCancelled: 'Scheduled message cancelled',
    scheduleCancelFailed: 'Could not cancel it',
    cancelSchedule: 'Cancel',
    scheduledPending: (count: number) => `Waiting to go out · ${count}`,
    nothingScheduled: 'Nothing scheduled here',
    nothingScheduledHint: 'Write a message first, then pick a time for it.',
